                           ...
                           dark:text-gray-200">
                            ...
                            border-b-2 border-gray-400">
                              <tr className="text-nowrap">
                                <th onClick={(e)=> sortChanged('id')} className="px-3 py-2  items-center justify-between gap-1 cursor-pointer">ID
                                <div>
                                ...
                                <th onClick={(e)=> sortChanged('name')} className="px-3 py-3  items-center justify-between gap-1 cursor-pointer">Name
                                <div>
                                <ChevronUpIcon className={"w-4 " +
                                  (queryParams.sort_field === "name" &&
                                  queryParams.sort_direction === "asc" ? "text-white" : "")
                                ...
                                <th onClick={(e)=> sortChanged('status')} className="px-3 py-3  items-center justify-between gap-1 cursor-pointer">Status
                                <div>
                                <ChevronUpIcon className={"w-4 " +
                                ...
                                <th onClick={(e)=> sortChanged('created_at')} className="px-3 py-3  items-center justify-between gap-1 cursor-pointer">Created Date
                                <div>
                                <ChevronUpIcon className={"w-4 " +
                                ...
                                <th onClick={(e)=> sortChanged('due_date')} className="px-3 py-3  items-center justify-between gap-1 cursor-pointer">Due Date
                                <div>
                                <ChevronUpIcon className={"w-4 " +
